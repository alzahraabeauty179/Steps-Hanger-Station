...
@php
    ...
    $uri = explode("/",(substr( $_SERVER['REQUEST_URI'], strpos( $_SERVER['REQUEST_URI'], "/") + 1)),3);
@endphp
...
<head>
    ...
    <meta name="description" content="{{$settings?->ResDesc()?? 'No description has been added yet'}}">
    <meta name="author" content="{{$settings?->ResDesc()?? 'Steps'}}">
