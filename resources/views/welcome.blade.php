    ...
    <ul id="menu-fillter" class="clearfix" style="direction: initial">
      @foreach($menuCategories as $menuCategory)
        <li><a href="#" data-filter=".pf-{{$menuCategory->id}}"
            style="color:#EDEDED">{{$menuCategory->categoryName()}}</a></li>
      @endforeach
                  ...
                  <div class="icons">
                    ...
                    {{-- <fieldset class="rating">--}}
                      {{-- <span class="active"><i class="fa fa-star"></i></span> <span class="active"><i
                          class="fa fa-star"></i></span> <span class="active"><i class="fa fa-star"></i></span> <span
                        class="active"><i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i></span>--}}
                      {{-- </fieldset>--}}
                    <!-- end Rating -->
                    <!-- Button -->
                    ...
                    <div class="row">
                      <div class="col-md-6 col-sm-6 col-sx-12">
                        <input name="full_name" class="form-control" type="text"
                          value="@auth{{auth()->guard('web')->user()->username}}@endauth" style="color: white"
                          placeholder="Your Name *" required>
                      </div>
                      <div class="col-md-6 col-sm-6 col-sx-12">
                        <input name="email" class="form-control"
                          value="@auth{{auth()->guard('web')->user()->email}}@endauth" style="color: white" type="email"
                          placeholder="email">
                      </div>
                      <div class="col-md-6 col-sm-6 col-sx-12">
                        <input id="phone" type="tel" name="phone" onclick="forceZeroRm()" class="form-control"
                          value="@auth{{auth()->guard('web')->user()->phone}}@endauth"
                          style="color: white;padding-right: 160px" placeholder="50xxxxxxx" required>
                      </div>
                      <br>
                      <div class="col-md-6 col-sm-6 col-sx-12">
                        <select class="form-control" name="branch_name">
                          ...
                          <option value="{{$branch->branchName()}}" style="color: rgb(102, 83, 255)">
                      ...
                      <div class="col-md-6 col-sm-6 col-sx-12">
                        <input name="num_of_persons" class="form-control" type="number" placeholder="Number of Persons"
                          required>
                      </div>
        ...
        {{-- <div class="row">--}}
          ...
          {{-- <div class="col-md-7 col-sm-12">--}}
            ...
            {{-- <div class="padding-100 app_content">--}}
              ...
              {{-- <p class="italic">We aim to home-produce as much as possible – for the best quality, and to reduce
                “food miles”. Our delicious cakes, traditional Devon scones, breads, soups, sauces and accompaniments
                are Even our bottled water is produced in-house, using a sophisticated seven-stage filtration .</p>--}}
              {{-- <!-- Buttons -->--}}
              {{-- <div class="buttons"> <a href="#" class="btn  btn-gold white" style="background-color:#6653ff">Google
                  play store</a> <a href="#" class="btn btn-gold white" style="background-color:#6653ff">Apple store</a>
              </div>--}}
              {{-- <!--End Buttons -->--}}
              {{-- </div>--}}
            {{-- <!-- End App Content -->--}}
          ...
          {{-- <div class=" col-md-4">--}}
            {{-- <div class="card" style="width: 18rem;box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;    padding: 20px;">
              ...
              {{-- <div class="card-body">--}}
                ...
                {{-- <a href="#" class="btn btn-primary" onclick="toastr.success('branch selected');"
