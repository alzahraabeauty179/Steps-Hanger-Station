...
<head>
  ...
  <!-- Plugins
     ============================================= -->
  <!-- Owl Carousal -->
  <link rel="stylesheet" href="{{assert('/stylesheets/owl.carousel.css')}}">
  <link rel="stylesheet" href="{{assert('/stylesheets/owl.theme.css')}}">
  <!-- Animate -->
  <link rel="stylesheet" href="{{assert('/stylesheets/animate.css')}}">
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{assert('/stylesheets/jquery.datetimepicker.css')}}">
  <!-- Pretty Photo -->
  <link rel="stylesheet" href="{{assert('/stylesheets/prettyPhoto.css')}}">
  <!-- Font awsome icons -->
  <link rel="stylesheet" href="{{assert('/stylesheets/font-awesome.min.css')}}">
  <!-- General Stylesheet
    ============================================= -->
  <!-- Custom Fonts Setup via Font-face CSS3 -->
  <link href="{{assert('/fonts/fonts.css')}}" rel="stylesheet">
  <!-- Main Template Styles -->
  <link href="{{assert('/stylesheets/main.css')}}" rel="stylesheet">
  <!-- Main Template Responsive Styles -->
  <link href="{{assert('/stylesheets/main-responsive.css')}}" rel="stylesheet">
  <!--[if lt IE 9]>
      <script src="{{assert('/javascripts/libs/html5shiv.js')}}"></script>
      <script src="{{assert('/javascripts/libs/respond.min.js')}}"></script>
    <![endif]-->
  <script src="{{ asset('js/app.js') }}" defer></script>
  <link href="{{assert('/admin/assets/css/toastr.min.css')}}" rel="stylesheet">
  ...
  <style>
    @font-face {
      font-family: saleem;
      src: assert('{{asset(' /fonts/Bahij_TheSansArabic-Bold.ttf')}}');
    }
...
<body style="font-family: 'saleem'">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MBMG7G9" height="0" width="0"
  ...
  <div id="wrapper">
    ...
    ============================================= -->
    {{-- <section id="bgndVideo" class="fullheight yt-bg-player player" class="player"
        ...
        <section id="" class="fullheight ">
          <div class="swiper-container swiper-parent fullheight">
            ...
            <div class="swiper-wrapper">
              ...
              <!-- Slide  -->
              {{-- <div class="swiper-slide"
                style="background-image: assert('/img/categories.jpg'); background-position: center top;background-size:cover">
                <div class="slider-content ">
          ...
          <div class="row">
            ...
            <div id="logo"> 
              ...
              <a href="/" class="dark-logo">
                <img
                  src="{{$settings?->logo?? 'img/tap_logo.png'}}" 
                  alt="Logo" 
