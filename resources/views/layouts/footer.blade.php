...
<script type="text/javascript">  
    var language = "{{ \Illuminate\Support\Facades\Session::get("locale")?? 'en'}}";
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i < response.length; i++) {
                    $('.cart_items').append(`
                        <div class="item clearfix cart_item_` + response[i].id + `"> <a href="#"><img src="` + response[i].meal_image + `" alt=""></a>
                            <div class="item_desc">
