...
<head>
  ...
  <script>
    ...
    (window, document, 'script', 'dataLayer', 'GTM-MBMG7G9');
  </script>
...
<body style="font-family: 'saleem'">
  ...
  <noscript>
    <iframe 
      src="https://www.googletagmanager.com/ns.html?id=GTM-MBMG7G9" 
      height="0" width="0"
  ...
  <div id="wrapper">
    ...
    {{-- 
      <section 
        id="bgndVideo" class="fullheight yt-bg-player player" class="player"
