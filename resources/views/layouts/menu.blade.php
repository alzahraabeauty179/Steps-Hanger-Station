@php
  if (Auth::guard('web')->check()) 
    $cartItems = \App\Models\Cart::where(["user_id" => \Auth::guard('web')->user()->id , "status" => 0])->latest()->get();
  else 
    $cartItems = \App\Models\Cart::where(["IP_ADDRESS"=> \Request::ip() , "status" => 0])->latest()->get();
        ...
        <ul>
          <li class="mega-menu-title">
            <div id="menu_carousel">
              <div class="item"> <a href="/menu"> <img class="img-responsive" src="{{url('img/drop_menu/8.jpg')}}" alt="starter">
                  <h2>Daily Dishes</h2>
                </a> </div>
          ...
          <li class="mega-menu-title">
            <div id="menu_carousel">
              <div class="item"> <a href="/menu"> <img class="img-responsive" src="{{url('img/drop_menu/6.jpg')}}" alt="starter">
                  <h2>Burgers</h2>
                </a> </div>
          ...
          <li class="mega-menu-title">
            <div id="menu_carousel">
              <div class="item"> <a href="/menu"> <img class="img-responsive" src="{{url('img/drop_menu/7.jpg')}}" alt="starter">
