...
<footer id="footer" class="padding-50 " style="background-color:{{$settings?->theme_colour?? 'blue'}};color: white;">
    <div class="container">
        <div class="row">
            <!-- Our location !-->
            <div class="col-md-3 col-sm-6 col-xs-12 our_location">
                ...
                <ul class="social mt30">
                    <li><a href="{{$settings?->facebook}}" target="_blank" data-toggle="tooltip" title="Facebook"
                            style="background-color: {{$settings?->text_colour}}"><i class="fab fa-facebook"></i></a>
                    </li>
                    <li><a href="{{$settings?->twitter}}" target="_blank" data-toggle="tooltip" title="Twitter"
                            style="background-color: {{$settings?->text_colour}}"><i class="fab fa-twitter"></i></a>
                    </li>
                    <li><a href="{{$settings?->instagram}}" target="_blank" data-toggle="tooltip" title="Instgram"
                            style="background-color: {{$settings?->text_colour}}"><i class="fab fa-instagram"></i></a>
                    </li>
                    <li><a href="{{$settings?->youtube}}" target="_blank" data-toggle="tooltip" title="Youtube"
                            style="background-color: {{$settings?->text_colour}}"><i class="fab fa-youtube"></i></a>
                    </li>
                </ul>
            </div>
            <!-- End our location -->
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            {{__('menu.from')}}
                            <time datetime="00:01" style="float: initial"> {{date('h:i A' ,
                                strtotime($settings?->cat_time_from_1))}} </time>
                        </p>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            {{__('menu.to')}}
                            <time datetime="00:01" style="float: initial"> {{date('h:i A' ,
                                strtotime($settings?->cat_time_to_4))}} </time>
                        </p>
...
<a href="#" id="scroll_up" style="background: {{$settings?->theme_colour?? 'blue'}}"><i class="fa fa-angle-up"></i></a> </div>
<!-- End wrapper -->
<!-- Core JS Libraries -->
<script>
...
<script>  var language = "{{ \Illuminate\Support\Facades\Session::get("locale")?? 'en'}}";</script>
<script>
